        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1.15fr]">
          ...
          <div className="naz-card rounded-[2rem] p-7 md:p-8">
            ...
            <form className="space-y-5">
              ...
              <button
                type="submit"
                className="inline-flex w-full items-center justify-center rounded-full border border-white bg-white px-6 py-4 text-xs font-semibold uppercase tracking-[0.22em] text-black transition hover:opacity-90"
              >
                Send Message
              </button>
