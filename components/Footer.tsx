  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-black">
      ...
      <div className="container-naz relative py-20">
        ...
        <div className="grid gap-16 border-b border-white/10 pb-16 lg:grid-cols-[1.4fr_0.7fr_0.7fr_0.9fr]">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-6 max-w-md text-sm leading-8 text-white/60">
              NAZ is a luxury streetwear label shaped by controlled intensity,
              refined silhouettes, and motorsport-inspired energy. Every piece
              is created to feel powerful the moment it is worn.
            </p>
        ...
        {/* TRUST STRIP */}
        <div className="grid gap-4 border-b border-white/10 py-6 text-[11px] uppercase tracking-[0.28em] text-white/40 sm:grid-cols-3">
